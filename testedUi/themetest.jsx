...
// Shared Premium TabBar Component (Exact styling from testedUi forms_bootstrap.jsx)
const SharedTabBar = (activeTab) => {
    return (
        <div className="flex flex-row items-center gap-4 px-4 overflow-x-scroll bg-gradient-horiz-indigo-153-purple-153 h-16 shadow-2xl border-t border-indigo-200">
            <div type="Column"
            ...
            <div type="Column"
                className={`flex flex-col items-center justify-center py-2 px-4 rounded-2xl ${activeTab === 'Bootstrap' ? 'bg-white/20' : 'bg-transparent'}`}
                action="nav:Bootstrap"
            >
                <span className="text-white text-base">🥾</span>
                <span className="text-white font-extrabold text-[10px] mt-1 tracking-wider">BOOTSTRAP</span>
            </div>
            <div type="Column"
...
const Alert = ({ type = 'info', title, message, action, className = '' }) => {
    ...
    return (
        <div
            className={`flex flex-row items-center gap-3 p-4 rounded-2xl ${alertColors.bg} ${className}`}
            action={action}
        >
            <span className="text-xl">{alertColors.icon}</span>
            <div className="flex flex-col flex-1 gap-0.5">
                {title && <span className="font-black text-xs text-white">{title}</span>}
                {message && <span className="text-[10px] text-white/80">{message}</span>}
            </div>
        </div>
    );
};
...
// HOME SCREEN: Form Inputs (MUI, Bootstrap, Flutter styles with dynamic icons!)
const buildHomeScreen = () => {
    return (
        <div className="flex flex-col flex-1 bg-slate-stateKey:theme">
            {/* Header / AppBar (Exact styling from testedUi) */}
            ...
            <div type="ListView" className="flex-1 p-0">
                ...
                {/* 🌟 NEW: Built-in Android System Icon Showcase Card */}
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-slate-800 font-extrabold text-sm">Built-in Android System Icons</span>
                        <span className="text-slate-253/80 text-[10px] uppercase font-black">Zero-Size Hardware-Accelerated Drawables</span>
                        </div>
                    </div>
                    <span className="text-slate-500 text-xs leading-relaxed">
                        Dolphin Native supports direct loading of standard Android drawables. Drag the theme slider below to change background contrast dynamically!
                    </span>

                    <div className="flex flex-row justify-around py-2 w-full">
                        <div className="flex flex-col items-center justify-center" style={{ width: 70 }}>
                            <div className="w-12 h-12 bg-indigo-50 border border-indigo-100 rounded-2xl items-center justify-center shadow-sm mb-1">
                                <img src="system:icon:ic_menu_add" className="w-6 h-6" />
                            </div>
                            <span className="text-slate-253 font-bold text-[9px]">Add</span>
                        </div>
                        <div className="flex flex-col items-center justify-center" style={{ width: 70 }}>
                            <div className="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl items-center justify-center shadow-sm mb-1">
                                <img src="system:icon:ic_menu_share" className="w-6 h-6" />
                            </div>
                            <span className="text-slate-253 font-bold text-[9px]">Share</span>
                        </div>
                        <div className="flex flex-col items-center justify-center" style={{ width: 70 }}>
                            <div className="w-12 h-12 bg-amber-50 border border-amber-100 rounded-2xl items-center justify-center shadow-sm mb-1">
                                <img src="system:icon:ic_menu_save" className="w-6 h-6" />
                            </div>
                            <span className="text-slate-253 font-bold text-[9px]">Save</span>
                        </div>
                        <div className="flex flex-col items-center justify-center" style={{ width: 70 }}>
                            <div className="w-12 h-12 bg-rose-50 border border-rose-100 rounded-2xl items-center justify-center shadow-sm mb-1">
                                <img src="system:icon:ic_menu_delete" className="w-6 h-6" />
                            </div>
                            <span className="text-slate-253 font-bold text-[9px]">Delete</span>
                        </div>
                    </div>
                </div>

                {/* 🌀 NEW: Ultra-light runtime transition demo (transform fast-path) */}
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        <span className="text-2xl">🌀</span>
                        <div className="flex flex-col">
                            <span className="text-slate-253 font-extrabold text-sm">Runtime Transition (Fast)</span>
                            <span className="text-slate-400 text-[10px] uppercase font-black">x-stateKey + transition-transform + duration</span>
                        </div>
                    </div>

                    <div className="flex flex-row gap-2 flex-wrap">
                        <div className="btn btn-primary" action="shiftX:=0">Left</div>
                        <div className="btn btn-secondary" action="shiftX:=60">Right</div>
                        <div className="btn btn-info" action="rot:=0">Rotate 0°</div>
                        <div className="btn btn-warning" action="rot:=45">Rotate 45°</div>
                    </div>

                    <div className="w-full h-20 bg-slate-100 rounded-2xl flex flex-row items-center overflow-hidden">
                        <div className="w-12 h-12 bg-indigo-500 rounded-2xl shadow-md x-stateKey:shiftX rotate-stateKey:rot transition-transform duration-300 ease-in-out" />
                    </div>
                </div>
                ...
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-slate-253 font-extrabold text-sm">Material UI (MUI) Showcase</span>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style A: Outlined Field</span>
                            <input
                                type="text"
                                variant="outlined"
                                stateKey="mui_name"
                        ...
                        {/* B. MUI Filled Input */}
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style B: Filled Field</span>
                            <input
                                type="email"
                                variant="filled"
                                stateKey="bs_email"
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style C: Standard Clean Field</span>
                            <input
                                type="phone"
                                variant="standard"
                                stateKey="mui_phone"
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style E: Floating Label</span>
                            <input
                                type="text"
                                variant="outlined"
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style F: Old HTML Style</span>
                            <span className="text-sm font-bold text-slate-253 ml-1">Static Label Outside</span>
                            <input
                                type="text"
                                variant="outlined"
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-253/80 font-black uppercase">Style D: Outlined Password</span>
                            <input
                                type="password"
                                variant="outlined"
                                stateKey="mui_pass"
                        ...
                        {/* G. Left Icon Only */}
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-400 font-black uppercase">Style G: Left Icon (Start Icon)</span>
                            <input
                                type="email"
                                variant="outlined"
                                stateKey="icon_email"
                        ...
                        {/* H. Right Icon Only */}
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-400 font-black uppercase">Style H: Right Icon (End Icon)</span>
                            <input
                                type="text"
                                variant="outlined"
                                stateKey="icon_search"
                                label="Search"
                        ...
                        {/* I. Both Left + Right Icons */}
                        <div className="flex flex-col gap-1">
                            <span className="text-[10px] text-slate-400 font-black uppercase">Style I: Both Icons (Lock + Eye)</span>
                            <input
                                type="password"
                                variant="filled"
                                stateKey="icon_both_pass"
                                label="Password"
                ...
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        <span className="text-2xl">🥾</span>
                        <div className="flex flex-col">
                            <span className="text-slate-253 font-extrabold text-sm">Bootstrap Style Controls</span>
                ...
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        <span className="text-2xl">💙</span>
                        <div className="flex flex-col">
                            <span className="text-slate-253 font-extrabold text-sm">Flutter Style Widgets</span>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-row items-center gap-6 text-slate-253">
                        ...
                        <div className="flex flex-col gap-2 w-full mt-2">
                            <span className="text-slate-253 font-extrabold text-xs">Custom Slider Value:</span>
                            <div
                                type="Slider"
                        ...
                        <div className="flex flex-col gap-2 w-full">
                            <span className="text-slate-253 font-extrabold text-xs">Dynamic UI Depth Theme:</span>
                            <input
                                type="range"
                                stateKey="theme"
                                initial="150"
                ...
                <div className="flex flex-row gap-4 mx-4 mb-8">
                    <div
                        ...
                        action="form:reset"
                    >
                        <span className="text-slate-253 font-extrabold text-sm">RESET FORM</span>
                    </div>
                    <div
                        className="flex-1 bg-gradient-horiz-indigo-153-purple-153 py-4 px-6 rounded-2xl flex flex-row items-center justify-center shadow-md active:scale-95 transition-all"
                        action="form:submit"
                    >
                        <img src="system:icon:ic_menu_save" className="w-5 h-5 mr-2" />
            ...
            <div type="ListView" className="flex-1 p-0">
                ...
                <div className="card bg-slate-stateKey:theme m-4 p-6 rounded-3xl shadow-xl border border-slate-100 flex flex-col gap-4">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-slate-253 font-extrabold text-base">Live Preview Terminal</span>
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-slate-253/80 text-[10px] uppercase font-black">Material Design Fields:</span>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Name:</span>
                            <span className="text-indigo-600 font-black text-xs">stateKey:mui_name|Anonymous</span>
                        </div>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Password Hash:</span>
                            <span className="text-indigo-600 font-black text-xs">stateKey:mui_pass|••••••••</span>
                        </div>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Phone:</span>
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        <span className="text-slate-253/80 text-[10px] uppercase font-black">Bootstrap Fields:</span>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Email:</span>
                            <span className="text-indigo-600 font-black text-xs">stateKey:bs_email|not provided</span>
                        </div>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Age:</span>
                            <span className="text-indigo-600 font-black text-xs">stateKey:bs_age|25</span>
                        </div>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Agreed Terms:</span>
                    ...
                    {/* Flutter Fields */}
                    <div className="flex flex-col gap-2 mt-2">
                        <span className="text-[10px] text-slate-253/80 font-black uppercase">Flutter Widgets:</span>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Payment Method:</span>
                            <span className="text-indigo-600 font-black text-xs">stateKey:payment_method|eSewa</span>
                        </div>
                        <div className="bg-slate-50/50 p-3 rounded-xl border border-slate-100 flex flex-row justify-between items-center">
                            <span className="text-slate-253 font-extrabold text-xs">Slider Limit:</span>
                ...
                <div className="flex flex-col gap-3 m-4">
                    <span className="text-slate-253/80 text-[10px] uppercase font-black">Native Reusable Alert Library:</span>
        ...
        <div className="flex flex-col flex-1 bg-slate-stateKey:theme">
            ...
            <div type="ListView" className="flex-1 p-0">
                <div className="card bg-slate-stateKey:theme m-4 p-5 rounded-3xl shadow-lg border border-slate-100 flex flex-col gap-5">
                    <span className="text-slate-800 font-extrabold text-lg mb-2">Full Bootstrap Form 🐬</span>

                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Full Name</span>
                        <input
                            type="text"
                            variant="outlined"
                            stateKey="bs_name"
                            ...
                            iconColor="blue"
                            iconSize="24"
                            className="w-full color-red-100 bg-blue-50"
                        />
                    </div>

                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Email Address</span>
                        <input
                            type="email"
                            variant="outlined"
                            stateKey="bs_email"
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Password</span>
                        <input
                            type="password"
                            variant="outlined"
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Age</span>
                        <input
                            type="number"
                            variant="outlined"
                            stateKey="bs_age"
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Date of Birth</span>
                        <input
                            type="text"
                            variant="outlined"
                            stateKey="bs_dob"
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-slate-253 font-bold text-xs">Country</span>
                        <div
                            type="Select"
                            stateKey="bs_country"
                            options="Nepal,India,USA,UK,Australia"
                            value="Nepal"
                            className="w-full border-gray-400  rounded-md bg-white border"
                        />
                    </div>

                    <div className="flex flex-col gap-2 mt-2">
                        <span className="text-slate-253 font-bold text-xs">Gender</span>
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        <span className="text-slate-253 font-bold text-xs">Volume / Range</span>
                        <div type="Slider" stateKey="bs_range" initial={50} className="w-full" />
                    </div>

                    <div className="mt-4 flex flex-row gap-4">
                        <div
                            className="flex-1 bg-gradient-horiz-indigo-153-purple-153 py-4 px-6 rounded-2xl flex flex-row items-center justify-center active:scale-95 transition-all shadow-md"
                            action="form:bs_submit"
                        >
                            <img src="system:icon:ic_menu_save" className="w-5 h-5 mr-2 text-slate-253" />
...
// DRAWER SCREEN: Left Sidebar Menu Panel (Augmented with beautiful System Icons!)
        ...
        <div className="flex flex-col h-full bg-slate-stateKey:theme">
            ...
            <div className="flex flex-col bg-gradient-horiz-indigo-153-purple-153 px-6 pt-12 pb-6 shadow-md gap-3 w-full">
                <div className="flex flex-row items-center gap-4">
                    ...
                    <div className="flex flex-col text-slate-253">
            ...
            <div type="ListView" className="flex-1 p-4 gap-2">
                <span className="text-slate-253/80 font-extrabold text-[9px] uppercase tracking-widest ml-3 mb-2">Navigation Panel</span>
                ...
                <div
                    ...
                    action="nav:Home"
                >
                    <img src="system:icon:ic_menu_view" className="w-5 h-5 mr-1" />
                    <span className="text-slate-253 font-extrabold text-xs">Form Laboratory</span>
                </div>
                ...
                <div
                    ...
                    action="nav:Bootstrap"
                >
                    <img src="system:icon:ic_menu_edit" className="w-5 h-5 mr-1 text-slate-253" />
                    <span className="text-slate-253 font-extrabold text-xs">Bootstrap Form</span>
                </div>
                ...
                <div
                    ...
                    action="nav:Details"
                >
                    <img src="system:icon:ic_dialog_info" className="w-5 h-5 mr-1 text-slate-253" />
                    <span className="text-slate-253 font-extrabold text-xs">Live Preview</span>
                </div>
                ...
                <div
                    ...
                    action="TOGGLE_FLASH"
                >
                    <img src="system:icon:ic_menu_camera" className="w-5 h-5 mr-1 text-slate-253" />
                    <span className="text-slate-253 font-extrabold text-xs">Toggle Flashlight</span>
                </div>
                ...
                <div
                    ...
                    action="form:reset"
                >
                    <img src="system:icon:ic_menu_rotate" className="w-5 h-5 mr-1 text-slate-253" />
                    <span className="text-slate-253 font-extrabold text-xs">Reset All States</span>
                </div>
            </div>
