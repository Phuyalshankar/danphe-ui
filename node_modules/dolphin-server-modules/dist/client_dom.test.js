    ...
    querySelectorAll(selector) {
        ...
        const traverse = (node) => {
            node.childNodes.forEach(child => {
                if (selector.includes('[data-rt-text]') && child.hasAttribute('data-rt-text'))
                    results.push(child);
                else if (selector.includes('[data-rt-html]') && child.hasAttribute('data-rt-html'))
                    results.push(child);
                else if (selector.includes('[data-rt-attr]') && child.hasAttribute('data-rt-attr'))
                    results.push(child);
                else if (selector.includes('[data-rt-class]') && child.hasAttribute('data-rt-class'))
                    results.push(child);
                else if (selector.includes('[data-rt-if]') && child.hasAttribute('data-rt-if'))
                    results.push(child);
                else if (selector.includes('[data-rt-hide]') && child.hasAttribute('data-rt-hide'))
                    results.push(child);
                else if (selector.includes('[data-api-get]') && child.hasAttribute('data-api-get'))
                    results.push(child);
                traverse(child);
            });
        };
...
describe('DOM Binding', () => {
    ...
    test('_updateDOM supports data-rt-type="context" for child element data passing', () => {
        ...
        global.document.querySelectorAll.mockReturnValue([parent]);
    ...
    test('request debouncing configuration (data-rt-debounce)', () => {
        ...
        const addEventListenerMock = global.document.addEventListener;
        const inputHandlers = [];
...
export {};
//# sourceMappingURL=client_dom.test.js.map