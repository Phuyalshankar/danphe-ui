...
<svg id="${id}" viewBox="0 0 360 560" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" 
    ...
    <g id="${id}-bottom-tabs" transform="translate(18, 400)">
        ...
        <g onclick="scrollTfTabsLeft('${id}')" style="cursor:pointer;" transform="translate(2, 6)">
            ...
            <path d="M 11,22 L 5,27 L 11,32" fill="none" stroke="#38bdf8" stroke-width="2" stroke-linecap="round" />
        </g>

        <g onclick="scrollTfTabsRight('${id}')" style="cursor:pointer;" transform="translate(306, 6)">
            <rect x="0" y="0" width="16" height="54" rx="4" fill="#090d16" stroke="#1e293b" stroke-width="1" />
            <path d="M 5,22 L 11,27 L 5,32" fill="none" stroke="#38bdf8" stroke-width="2" stroke-linecap="round" />
        </g>
        ...
        <foreignObject x="22" y="4" width="280" height="58">
            <div xmlns="http://www.w3.org/1999/xhtml" 
                ...
                <button type="button" id="${id}-tab-transform" onclick="switchTfTab('${id}', 'transform')"
                        style="flex-shrink:0; width:70px; height:54px; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:3px; border-radius:10px; background:#082f49; border:2px solid #38bdf8; box-shadow:0 0 12px rgba(56,189,248,0.5); cursor:pointer; color:#ffffff;">
                    <span style="font-size:15px; line-height:1;">📐</span>
                ...
                <button type="button" id="${id}-tab-typo" onclick="switchTfTab('${id}', 'typo')"
                        style="flex-shrink:0; width:70px; height:54px; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:3px; border-radius:10px; background:#090d16; border:1.2px solid #1e293b; cursor:pointer; color:#94a3b8;">
                    <span style="font-size:15px; line-height:1;">🔤</span>
                    <span style="font-size:9px; font-weight:900; letter-spacing:0.5px; color:#fde047;">TYPO</span>
                </button>

                <button type="button" id="${id}-tab-vfx" onclick="switchTfTab('${id}', 'vfx')"
                        style="flex-shrink:0; width:70px; height:54px; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:3px; border-radius:10px; background:#090d16; border:1.2px solid #1e293b; cursor:pointer; color:#94a3b8;">
                    <span style="font-size:15px; line-height:1;">💥</span>
                    <span style="font-size:9px; font-weight:900; letter-spacing:0.5px; color:#ef4444;">VFX</span>
                </button>

                <button type="button" id="${id}-tab-thumb" onclick="switchTfTab('${id}', 'thumb')"
                        style="flex-shrink:0; width:70px; height:54px; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:3px; border-radius:10px; background:#090d16; border:1.2px solid #1e293b; cursor:pointer; color:#94a3b8;">
