...
module.exports = {
    ...
    renderTitanMobileSimulator: require('./TitanMobileSimulator').renderTitanMobileSimulator,
    TitanMobileSimulator: require('./TitanMobileSimulator').renderTitanMobileSimulator,
    TitanChromiumEngine: require('./TitanChromiumEngine').TitanChromiumEngine,
    FONTS_256,
    getFontFromOpcode,
    generateFontCSS,
    EFFECTS_256,
