...
<svg id="${id}" viewBox="0 0 360 560" width="360" height="560" class="select-none overflow-visible block" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- ═════════════════════════════════════════════════════════════════════════
         LAYER 7: MASTER ACTION BUTTON (APPLY TO TIMELINE)
    ══════════════════════════════════════════════════════════════════════════ -->
    <g id="${id}-master-btn-group" transform="translate(18, 408)" class="cursor-pointer" onclick="applyVfxToTimeline('${id}')">
        <rect x="0" y="0" width="324" height="38" rx="10" fill="#450a0a" stroke="#ef4444" stroke-width="1.5" filter="url(#${id}-glow-vfx)" />
        <text x="162" y="23.5" font-size="10.5" font-family="'JetBrains Mono', monospace" font-weight="900" fill="#fee2e2" text-anchor="middle" letter-spacing="1">💥 APPLY VFX POWER SHADER TO TIMELINE</text>
    </g>

    <!-- ═════════════════════════════════════════════════════════════════════════
         LAYER 8: 6 SPACIOUS 70px WIDE BOTTOM DOCK TABS
    ══════════════════════════════════════════════════════════════════════════ -->
    <!-- Scroll Arrow Left -->
    <g class="cursor-pointer" transform="translate(2, 472)" onclick="scrollVfxTabsLeft('${id}')">
    ...
    <!-- Scroll Arrow Right -->
    <g class="cursor-pointer" transform="translate(342, 472)" onclick="scrollVfxTabsRight('${id}')">
        <rect x="0" y="0" width="16" height="58" rx="4" fill="#090d16" fill-opacity="0.9" stroke="#1e293b" stroke-width="1" />
        ...
        <foreignObject x="0" y="0" width="320" height="58">
            <div xmlns="http://www.w3.org/1999/xhtml" id="${id}-tabs-viewport" class="flex items-center gap-1.5 overflow-x-auto custom-scrollbar w-full h-full pb-1" style="scrollbar-width:none;-ms-overflow-style:none;">
                ...
                <button type="button" id="${id}-tab-typo" onclick="switchVfxTab('${id}', 'typo')"
                        class="flex-shrink-0 w-[70px] h-[58px] flex flex-col items-center justify-center gap-1 rounded-xl transition-all duration-150 bg-slate-900/90 border border-slate-800 hover:border-slate-700 hover:bg-slate-800">
                    <span class="text-base leading-none">🔤</span>
                    <span class="text-[9px] font-black tracking-wider text-amber-400">TYPO</span>
                </button>

                <!-- Tab 5: 💥 VFX (ACTIVE) -->
                <button type="button" id="${id}-tab-vfx" onclick="switchVfxTab('${id}', 'vfx')"
                        class="flex-shrink-0 w-[70px] h-[58px] flex flex-col items-center justify-center gap-1 rounded-xl transition-all duration-150 bg-red-950 border-2 border-red-500 shadow-[0_0_12px_rgba(239,68,68,0.6)]">
                    <span class="text-base leading-none">💥</span>
                    <span class="text-[9px] font-black tracking-wider text-red-300">VFX</span>
                </button>

                <!-- Tab 6: 🎵 AUDIO -->
                <button type="button" id="${id}-tab-audio" onclick="switchVfxTab('${id}', 'audio')"
                        class="flex-shrink-0 w-[70px] h-[58px] flex flex-col items-center justify-center gap-1 rounded-xl transition-all duration-150 bg-slate-900/90 border border-slate-800 hover:border-slate-700 hover:bg-slate-800">
                    <span class="text-base leading-none">🎵</span>
                    <span class="text-[9px] font-black tracking-wider text-slate-400">AUDIO</span>
                </button>
