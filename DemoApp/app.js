...
const SharedTabBar = (activeScreen) => (
    <div className="flex flex-row bg-gradient-horiz-indigo-153-purple-153 border-t border-indigo-700 flex-shrink-0 shadow-2xl" style={{ height: 60 }}>
        <div className={`flex flex-col p-0 items-center justify-center transition-all ${activeScreen === 'Home' ? 'bg-indigo-900/40' : ''}`} action="nav:Home">
